...
Sehir_bosanma_sayisi_2001 <- read_excel("veri/Sehir_bosanma_sayisi_2001.xlsx")
View(Sehir_bosanma_sayisi_2001)
...
veri_long <- veri %>%
  ...
  filter(!is.na(Yuzde))  # NA varsa temizle

# Grafik
ggplot(veri_long, aes(x =Yuzde , y =Bosanma_Nedeni ,fill= Grup )) +
  geom_bar(stat = "identity", position = position_dodge()) +
  labs(
    title = "2006 ve 2021 Yıllarında Erkek ve Kadınların Boşanma Nedenleri",
    x = "Bosanma Nedeni", y = "Yuzde (%)", fill = "Grup"
  ) +
  theme_minimal() +
  theme(
    axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1),
